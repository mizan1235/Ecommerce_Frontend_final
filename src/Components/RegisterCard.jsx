...
const RegisterCard = () => {
  ...
  const onSubmit=(e)=>{
    ...
    fetch('https://ecommercebackendfinal-production.up.railway.app/Mizan/create_user', {
      method: "POST",
      headers: {
  ...
  return (
    <div className='login-card-container'>
            ...
            <div className="login-btn">Already Signed Up <span className='reg'><Link to="/login">Login</Link></span></div>
